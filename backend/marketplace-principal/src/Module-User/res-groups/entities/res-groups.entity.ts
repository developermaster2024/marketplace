import { IrModelAccessGroupsRel } from 'src/Module-User/ir-model-access-groups-rel/entities/ir-model-access-groups-rel.entity';
import { IrModelAccess } from 'src/Module-User/ir-model-access/entities/ir-model-access.entity';
import { IrRule } from 'src/Module-User/ir-rule/entities/ir-rule.entity';
import { ResGroupsImpliedIds } from 'src/Module-User/res-groups-implied-ids/entities/res-groups-implied-ids.entity';
